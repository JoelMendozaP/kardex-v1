...
if (isset($_GET['codcartainterna'])) {
	$codcartainterna = $_GET['codcartainterna'];
...
$query = "SELECT * FROM carta c,recibe r , usuarios u  WHERE c.cod_carta =$codcartainterna and r.cod_carta = $codcartainterna and r.dnia= u.dni";
        ...
        WHERE a.cod_carta = $codcartainterna and a.codhistorialusu=u.cod_user ORDER by a.fech_proc";
...
$pdf->MultiCell(145,7,utf8_decode('HISTORIAL DE LA CARTA INTERNA'),'C', 1);
