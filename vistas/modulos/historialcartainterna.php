...
include("conexionmysqli.php");
      if (isset($_GET["idcartahitorial"])) {
        ...
        $idchi = $_GET["idcartahitorial"];
        $idusu= $_GET["codu"];

        

        $query = "SELECT * FROM carta c,recibe r , usuarios u  WHERE c.cod_carta =$idchi and r.cod_carta = $idchi and u.cod_user = $idusu ";
    ...
    <div class="box bg-gray disabled" >
      <?php
       echo '<button class="btn btn-danger btn-lg btnhistorialinterna" codcartainterna="'.$idchi.'" idusuinternas="'.$idusu.'"  > <i class="fa fa-print"> GENERAR PDF</i>
        </button>'?>
        <br>
      </div>
        ...
        <table class="table table-bordered table-striped dt-responsive tablas" style="width:100%">
          ...
          <tbody>
            ...
            if (isset($_GET["idcartahitorial"])) {
              ...
              $historialc = Controladorcorespinterna::ctrMostrarhistorial($item, $valor, $idchi);
