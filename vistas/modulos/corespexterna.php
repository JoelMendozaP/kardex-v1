                    ...
                    <div class="tab-pane fade " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" style="background: skyblue ">
                      ...
                      echo '<td>' . $value["observacion"] . '</td>
                                ...
                                echo'
                                 ...
                                 <button class="btn bg-gray-active historialcartas"  idcartahitorialex="' . $value["cod_carta"] . '" codu="' . $value["cod_user"] . '"  title="HISTORIAL DE LA CARTA"> <i class="fa fa-download"></i></button>';
                                 }
                                 echo'
