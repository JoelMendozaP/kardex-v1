...
class Controladorcoresexterna
{
/*=============================================
	INGRESAR CARTA EXTERNA
	=============================================*/

    static public function CtrCrearcartaext()
    {
            ...
            if (
                ...
                if (isset($_FILES["nuevafotocarta"]["tmp_name"])) {
                    ...
                    if ($_FILES["nuevafotocarta"]["type"] == "application/pdf") {
                        $directorio = "vistas/img/cartas/Externa/" . $_POST["nuevoremitente"];
                  ...
                  if (!file_exists($directorio)) {
                      mkdir($directorio, 0755);
                        ...
                        $ruta = "vistas/img/cartas/Externa/" . $_POST["nuevoremitente"] . "/" . $aleatorio . ".pdf";
                        ...
                        =============================================*/
                            ...
                            $ruta = "vistas/img/cartas/Externa/" . $_POST["nuevoremitente"] . "/" . $aleatorio . ".jpg";
                        ...
                        =============================================*/
                            ...
                            $ruta = "vistas/img/cartas/Externa/" . $_POST["nuevoremitente"] . "/" . $aleatorio . ".png";
                ...
                $respuesta = Modelocorespexterna::mdlIngresarcartaexterna($tabla,$tabla1,$datos,$clave2,$tabla2);
    ...
    /*=============================================
	MOSTRAR  CORESP EXTERNA
	=============================================*/
    static public function ctrMostrarcoresexterna($item, $valor)
    {
        $tabla = "carta";
        $tabla1 = "usuarios";
        $tabla2 = "recibe";
        $respuesta = Modelocorespexterna::MdlMostrarcorespexterna($tabla, $tabla1,$tabla2, $item, $valor);
        return $respuesta;
    }

    
    /*=============================================
	MOSTRAR  CARTA HISTORIAL EXTERNA
	=============================================*/
    static public function ctrMostrarhistorial($item, $valor, $id)
    {
        $tabla = "administrado";
        $tabla1 = "usuarios";
        $respuesta = Modelocorespexterna::MdlMostrarhistorial($item, $valor,$id,$tabla,$tabla1);
        return $respuesta;
    }
 ...
 /*=============================================
	...
	=============================================*/
    static public function ctrMostrarcartacreadaex($item, $valor)
    {
        $tabla = "crearcarta";
        $tabla1 = "usuarios";
        $tabla2 = "crearc";
        $respuesta = Modelocorespexterna::MdlMostrarcrearcartaex($tabla, $tabla1,$tabla2, $item, $valor);
        return $respuesta;
    }
	...
	=============================================*/
    static public function ctreditarcartaext()
    {
        ...
        if (isset($_POST["editarfechacarta"])) {
				  ...
				  =============================================*/
                   ...
                   if (isset($_FILES["editarfotocarta"]["tmp_name"]) && !empty($_FILES["editarfotocarta"]["tmp_name"])) {
                    ...
                    if ($_FILES["editarfotocarta"]["type"] == "application/pdf") {
                        ...
                        $directorio = "vistas/img/cartas/Externa/" . $_POST["editarremitente"];
                            ...
                            GUARDAMOS EL PDF EN EL DIRECTORIO
                              =============================================*/
                                $aleatorio = mt_rand(100, 999999);
                                $ruta = "vistas/img/cartas/Externa/" . $_POST["editarremitente"] . "/" . $aleatorio . ".pdf";
                    ...
                    if ($_FILES["editarfotocarta"]["type"] == "image/jpeg") {
                        ...
                        $ruta = "vistas/img/cartas/Externa/" . $_POST["editarremitente"] . "/" . $aleatorio . ".jpg";
                    ...
                    if ($_FILES["editarfotocarta"]["type"] == "image/png") {
                        ...
                        $ruta = "vistas/img/cartas/Externa/" . $_POST["editarremitente"] . "/" . $aleatorio . ".png";
                ...
                $respuesta =  Modelocorespexterna::mdleditarcartaext($tabla,$tabla1,$datos,$clave2,$idcarta);
	...
	=============================================*/
    static public function ctrBorrarCartaexterna()
    {
        ...
        if (isset($_GET["idcartas"])) {
            ...
            $respuesta = Modelocorespexterna::mdlBorrarcartaext($tabla, $datos);
...
/*=============================================
	CREAR CARTA EXTERNA
	=============================================*/
    static public function CtrCrearcex()
    {
        if (isset($_POST["dirijida"])) {
            ...
            if (
                ...
                $clave2=$_POST["user"];
                $respuesta = Modelocorespexterna::mdlcrearcex($tabla,$tabla1,$datos,$clave2);
    ...
    /*=============================================
	EDITAR CARTA CREADA EXTERNA
	=============================================*/
    static public function ctreditarcartacreadasex()
    {
        ...
        if (isset($_POST["editardirijida"])) {
             ...
             $respuesta = Modelocorespexterna::mdleditarcrearcex($tabla,$tabla1,$datos,$codigocartac,$dnis);
...
=============================================*/
static public function ctrBorrarCartacreadaex()
{
    ...
    if (isset($_GET["codcartacreada"])) {
        ...
        $respuesta = Modelocorespexterna::mdlBorrarcartacreadaex($tabla, $datos);
        if ($respuesta == "ok") {
...
/*=============================================
	ASIGNAR CARTA CARTA EXTERNA
	=============================================*/
    static public function ctrassignarex()
    {
        ...
        if (isset($_POST["rutahistorial"])) {
				  ...
				  =============================================*/
                   ...
                   if (isset($_FILES["editarfotocartahistorial"]["tmp_name"]) && !empty($_FILES["editarfotocartahistorial"]["tmp_name"])) {
                    ...
                    if ($_FILES["editarfotocartahistorial"]["type"] == "application/pdf") {
                        ...
                        $directorio = "vistas/img/cartas/Externa/" . $_POST["editarremitentes"];
                ...
                $respuesta =  Modelocorespexterna::mdlasignarcartaext($tabla,$tabla1,$tabla2,$datos,$idcartas,$datos1,$codausuario);
